...
ALTER TABLE COMMENT_LIKE ADD CONSTRAINT COMMENT_LIKE_COMMEMT_CODE_FK FOREIGN KEY(COMMENT_CODE) REFERENCES VIDEO_COMMENT;
...
-- 채널 추가
INSERT INTO CHANNEL(CHANNEL_CODE, CHANNEL_NAME, MEMBER_ID) VALUES(SEQ_CHANNEL.NEXTVAL, '채널이름', 'user1');
COMMIT;
SELECT * FROM CHANNEL;
