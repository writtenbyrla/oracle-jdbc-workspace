...
SELECT * FROM TB_STUDENT WHERE STUDENT_NAME = '한효종';

-- 결합 인덱스 생성
CREATE INDEX IDX_STUDENT_CLASS_NO
ON TB_GRADE(STUDENT_NO, CLASS_NO);

SELECT * FROM TB_GRADE WHERE STUDENT_NO = 'A357025' AND CLASS_NO = 'C4507100';
...
*/
DROP SYNONYM EMP01; -- KH
DROP PUBLIC SYNONYM DEPT; -- SYS